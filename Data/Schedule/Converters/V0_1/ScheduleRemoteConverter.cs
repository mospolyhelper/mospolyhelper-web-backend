namespace Mospolyhelper.Data.Schedule.Converters.V0_1
{
    using System;
    ...
    public class ScheduleRemoteConverter
    {
        ...
        public IList<Schedule> ParseSchedules(string schedulesString)
        {
        ...
        private Schedule ParseSchedule(JsonElement json)
        {
